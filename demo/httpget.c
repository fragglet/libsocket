 ...
 *
 * Some modifications by Richard Dawe for libsocket 0.7.4:
 *
 * 1999-01-21: RD modified it to use herror().
 * 2000-03-03: Removed lsck_perror(), since it should now work without it.
 */
...
{
  /*char BUF[0x10000];*/
  char BUF[32768];   /* RD: Try a smaller buffer */
  int t = 0;         /* RD: Safety */
